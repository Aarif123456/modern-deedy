...
\runsubsection{University of Windsor}\hfill\location{Jun 2021}\\
\descript{BSc. Computer Science with Software Engineering Specialization}\hfill\location{Windsor, ON}\\
\smallSep

\resumeSubheading{Research Assistant (RA)}{Feb 2020 - May 2020}
\begin{tightemize}
...
\smallSep
\resumeSubheading{Teacher Assistant (TA)}{Jan 2021 - Apr 2021}
\begin{tightemize}
...
%     \item{
%         \location{Languages:} Java, C++, Python, C\#, PHP, JavaScript, TypeScript, HTML/CSS, Prolog, Bash, Racket
%         \\
...
\begin{resumeSkillList}
    ...
    \hspace*{\fill} 
    \location{Web Development:}J avaScript, React, CSS, HTML
    \\
